...
import '../../progress/utils/muscle_group_options.dart';
import '../../../shared/widgets/category_filter.dart';
import '../widgets/exercise_library_card.dart';
import '../../routines/widgets/routine_library_card.dart';
import '../../../core/widgets/loading_state_widget.dart';
import 'exercise_form_page.dart';
import '../../routines/pages/routine_form_page.dart';
...
class _ExercisePageState extends State<ExercisePage>
  ...
  Future<void> _loadExercisesAndRoutines() async {
    try {
      ...
      if (kDebugMode) print('Error loading exercises and routines: $e');
      if (mounted) {
        ...
        builder: (context) => ExerciseFormPage(
          ...
          onSave: (exerciseData) async {
            try {
              ...
              if (kDebugMode) print('Error saving exercise: $e');
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
        ...
        builder: (context) => ExerciseFormPage(
          ...
          onSave: (exerciseData) async {
            try {
              ...
              if (kDebugMode) print('Error updating exercise: $e');
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
        ...
        builder: (context) => RoutineFormPage(
          ...
          onSave: (routineData) async {
            try {
              ...
              if (kDebugMode) print('Error saving routine: $e');
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
  ...
  Widget build(BuildContext context) {
    return LoadingStateWidget(
      ...
      loadingMessage: 'Loading exercises and routines...',
      onRetry: _loadExercisesAndRoutines,
